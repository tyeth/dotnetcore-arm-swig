...
SWIGEXPORT void SWIGSTDCALL CSharp_My_variable_set(double jarg1) {
  double arg1 ;
...
SWIGEXPORT double SWIGSTDCALL CSharp_My_variable_get() {
  double jresult ;
  double result;
...
SWIGEXPORT int SWIGSTDCALL CSharp_my_mod(int jarg1, int jarg2) {
  int jresult ;
  int arg1 ;
  int arg2 ;
  int result;
...
SWIGEXPORT char * SWIGSTDCALL CSharp_get_time() {
  char * jresult ;
  char *result = 0 ;
